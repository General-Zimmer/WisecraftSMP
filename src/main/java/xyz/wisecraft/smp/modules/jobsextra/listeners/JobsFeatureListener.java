...
public class JobsFeatureListener implements org.bukkit.event.Listener {
    ...
    public JobsFeatureListener(JobsExtrasModule module) {
        ...
        jobLevels.put(miner, module.getPlugin().getConfig().getInt("JOBS_SETTINGS.MINER_ABILITY_LEVEL", defaultLevel));
        this.blacksmith = module.getSpecificJob("Blacksmith");
        jobLevels.put(blacksmith, module.getPlugin().getConfig().getInt("JOBS_SETTINGS.BLACKSMITH_ABILITY_LEVEL", defaultLevel));
        this.farmer = module.getSpecificJob("Farmer");
        jobLevels.put(farmer, module.getPlugin().getConfig().getInt("JOBS_SETTINGS.FARMER_ABILITY_LEVEL", defaultLevel));
