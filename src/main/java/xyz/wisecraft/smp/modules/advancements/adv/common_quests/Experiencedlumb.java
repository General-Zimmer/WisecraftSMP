...
public class Experiencedlumb extends BaseAdvancement implements VanillaVisibility {
  ...
  public Experiencedlumb(Advancement parent, float x, float y) {
    super(KEY.getKey(), new AdvancementDisplay(Material.STONE_AXE, "Experienced lumber", AdvancementFrameType.CHALLENGE, true, true, x, y , "One heck of a cutter. You've cut 5000 trees!"), parent, 1);
  }
}