...
public class Lumberjack extends BaseAdvancement implements VanillaVisibility {
  ...
  public Lumberjack(Advancement parent, float x, float y) {
    super(KEY.getKey(), new AdvancementDisplay(Material.WOODEN_AXE, "Lumber Jack", AdvancementFrameType.GOAL, true, true, x, y , "I am a Jack, and I'm cutting cutting logs (1000 of them)"), parent, 1);
  }
}