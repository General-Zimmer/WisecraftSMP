...
public class Gettingjob extends BaseAdvancement  {
  ...
  public Gettingjob(Advancement parent, float x, float y) {
    super(KEY.getKey(), new AdvancementDisplay(Material.FLETCHING_TABLE, "Get a job (hippie!)", AdvancementFrameType.TASK, true, false, x, y , "Join a job by /jobs join <job>"), parent, 1);
